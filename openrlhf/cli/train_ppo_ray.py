...
if __name__ == "__main__":
    ...
    parser.add_argument("--use_dads", action="store_true", default=False, help="whether to use DADS from View-R1")
    parser.add_argument("--use_stcr", action="store_true", default=False, help="whether to use STCR from View-R1")
    ...
    if args.processor_kwargs:
        ...
        args.processor_kwargs = {"min_pixels": 4 * 28 * 28, "max_pixels": 10000 * 16 * 16}
        # args.processor_kwargs = {"min_pixels": 4 * 28 * 28, "max_pixels": 10000 * 25 * 25}
